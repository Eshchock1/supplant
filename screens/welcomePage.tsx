...
render(){
  return (
      ...
      <Progress.Bar style={{marginTop:(Dimensions.get("window").width + Dimensions.get("window").height) / (1080/10), zIndex:10, borderRadius:(Dimensions.get("window").width + Dimensions.get("window").height) / (1080/20),}} color={'#DAA520'} unfilledColor={'#D3D3D3'} borderWidth={0} height={(Dimensions.get("window").width + Dimensions.get("window").height) / (1080/30)} progress={0.2} width={(Dimensions.get("window").width + Dimensions.get("window").height) / (1080/200)} />
      <TouchableOpacity onPress={()=> Alert.alert("Ingredients:", "Cheese, Lettuce, Tomato, Bun, Cheddar, Bread, Beef")}><Text style={{color:'#494949', paddingTop:6, fontSize:20, fontWeight:'bold'}}>View Ingredients</Text></TouchableOpacity>
