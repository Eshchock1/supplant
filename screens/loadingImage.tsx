...
import { StyleSheet, Text, View, KeyboardAvoidingView,TouchableWithoutFeedback, AsyncStorage, Keyboard, BackHandler, Image, ScrollView, Dimensions} from 'react-native';
...
state = {
  ...
  formData =() => {
    ...
    axios.post('https://us-central1-supplant-44e15.cloudfunctions.net/api/foodUpload', form, {
headers:{
  "content-type" : "multipart/formdata"
}
    }).then(((bruh)=> {console.log(bruh)}))
  }
