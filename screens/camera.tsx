                ...
                style={{
                  fontSize:
                    (Dimensions.get("window").width +
                      ...
                      (Dimensions.get("window").width + Dimensions.get("window").height) / (1080/50),
                  color: "white",
                }}
              >
<AntDesign name="reload1" size={(Dimensions.get("window").width + Dimensions.get("window").height) / (1080/40)} color="white" />
</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                ...
                borderColor: "#e0e0e0",
                borderWidth: (Dimensions.get("window").width + Dimensions.get("window").height) / (1080/6),
              }}
              onPress={async () => {
                if (camera) {
                  console.log("pressed");
...
<AntDesign name="back" size={(Dimensions.get("window").width + Dimensions.get("window").height) / (1080/40)} color="white" /></Text>
            </TouchableOpacity>
          </View>
    </View>
  );
